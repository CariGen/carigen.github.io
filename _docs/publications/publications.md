...
<ul>
<div class="container">
    <button type="button" class="btn btn-outline-primary btn-xs" data-toggle="collapse" data-target="#Corgosinho_2016">ABSTRACT</button>
        <div id="Corgosinho_2016" class="collapse">
